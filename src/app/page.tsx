...
secureLog.info('portfolio history updated', {
      ...
      <div className="lg:col-span-2 order-2 lg:order-1">
        <div className="bg-gray-800/50 rounded-xl p-4 sm:p-6 relative z-10">
          ...
          <TokenTable
            ...
            excludeTokenMint={selectedOutputToken} columns={[]} onUpdateColumnWidth={function (columnId: string, width: number): void {
              throw new Error('Function not implemented.');
            } } onToggleColumnVisibility={function (columnId: string): void {
              throw new Error('Function not implemented.');
            } } onReorderColumns={function (oldIndex: number, newIndex: number): void {
              throw new Error('Function not implemented.');
            } } onShowColumnPanel={function (): void {
              throw new Error('Function not implemented.');
            } }          />
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-1000 via-black to-black-1000 text-white">
      {/* Remove all the complex width containers and use simple ones */}
      <div className="w-full overflow-x-hidden">
        <div className="w-full">
          <div className="w-full">
            <header className="flex justify-between items-center mb-6 p-4 bg-gray-1000/30 border-b border-gray-700/50 w-full">
            ...
            {showMobileMenu && (
              <div className="sm:hidden mb-6 p-5 bg-gray-800/50 border-b border-gray-700/50 w-full">
            ...
            <main className="w-full px-4 sm:px-6 mb-8">
              <div className="w-full">
            ...
            {currentView === 'main' && (
              <div className="w-full px-4 sm:px-6 mb-8 space-y-6">
                <SwapHistoryPanel />
                <HistoricalPortfolio />
              </div>
            )}
            
            <footer className="w-full px-4 sm:px-6 mt-8 pt-6 border-t border-gray-700/30">
